...
class CaptioningRNN(object):
  ...
  def loss(self, features, captions):
    """
    Compute training-time loss for the RNN. We input image features a nd
    ...
    dW_embed  = word_embedding_backward(dx_rnn, cache_embedding)
  ...
  def sample(self, features, max_length=30):
    ...
    while i<max_length:
      # print(word.shape)
      x, cache_embedding = word_embedding_forward(word, W_embed)
      x=np.squeeze(x)
