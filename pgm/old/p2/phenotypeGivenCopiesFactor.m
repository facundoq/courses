...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
phenotypeFactor = struct('var', [phenotypeVar, geneCopyVarOne, geneCopyVarTwo], 'card', [2 numAlleles numAlleles], 'val', []);
...
for i=1:prod(phenotypeFactor.card)
    ...
    genotype_index = allelesToGenotypes(assignment(2), assignment(3));    
    phenotypeFactor.val(i) = alphaList(genotype_index);
    if assignment(1) == 2
