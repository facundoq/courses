...
assert(eq_eps(phenotypeFactorAlpha.val,phenotypeFactorAlpha2.val));
...
assert(eq_eps(genotypeFactor.val,genotypeFactor2.val));
...
assert(eq_eps(genotypeFactorPar.val,genotypeFactorPar2.val));
...
sampleFactorList=sampleFactorList.sampleFactorList;
sampleFactorList2 = constructGeneticNetwork(pedigree, alleleFreqs, alphaList);
assert(eq_factors(sampleFactorList,sampleFactorList2));
...
assert(eq_factors(phenotypeFactorPar,phenotypeFactorPar2));
...
sampleFactorListDecoupled=sampleFactorListDecoupled.sampleFactorListDecoupled;
sampleFactorListDecoupled2 = constructDecoupledGeneticNetwork(pedigree, alleleFreqsThree, alphaListThree);
assert(eq_factors(sampleFactorListDecoupled,sampleFactorListDecoupled2));
...
assert(eq_factors(phenotypeFactorSigmoid,phenotypeFactorSigmoid2));