...
% Factor Product
FACTORS.PRODUCT_COMPUTED = FactorProduct(FACTORS.INPUT(1), FACTORS.INPUT(2));
...
% Observe Evidence
FACTORS.EVIDENCE_COMPUTED = ObserveEvidence(FACTORS.INPUT, [2 1; 3 2]);
